...
ob_start();
$API_KEY = '384742340:AAETgAQr48DrdczySb6gOCI0dmwHQeuKaM8';
...
if($text){
	bot('sendmessage',[
		'chat_id'=>$chat_id, 
		'text'=>"This bot can help you find and share GIFs. It works automatically, no need to add it anywhere. Simply open any of your chats and type something in the message field. Then tap on a result to send.

For example, try typing some shit like happy dog here.
",
	]);
}
